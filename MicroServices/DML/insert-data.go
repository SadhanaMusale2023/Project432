...
func saveDataToPostgres(db *sql.DB, data []map[string]interface{}) error {
	for _, item := range data {
		...
		_, err := db.Exec(`INSERT INTO permits (id, permit, permit_type, application_start_date, issue_date, latitude, longitude
			 , xcoordinate, ycoordinate) 
		VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)`,
			item["id"], item["permit"], item["permit_type"],
			item["application_start_date"], item["issue_date"],
			item["latitude"],
